...
Patch4: python-imaging-shebang.patch
...
for scr in *.py
do
  sed -e "s|/usr/local/bin/python|%{__python}|"  $scr > tmp.py
  mv tmp.py $scr
  chmod 755 $scr
done
...
%changelog
* Sat Jul 21 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.1.7-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_18_Mass_Rebuild

* Sat Jan 14 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.1.7-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_17_Mass_Rebuild

* Wed Sep 07 2011 Roman Rakus <rrakus@redhat.com> - 1.1.7-5
- Check for fedora < 9 is not necessary

* Tue Jun 07 2011 Roman Rakus <rrakus@redhat.com> - 1.1.7-4
- Buffer overflow patch (#703212)

* Tue Feb 08 2011 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.1.7-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Thu Jul 22 2010 David Malcolm <dmalcolm@redhat.com> - 1.1.7-2
- Rebuilt for https://fedoraproject.org/wiki/Features/Python_2.7/MassRebuild

* Tue Jun 01 2010 Roman Rakus <rrakus@redhat.com> - 1.1.7-1
- Update to 1.1.7
